SELECT le.lecture_id, le.lecture_img, le.lecture_title, le.lecture_category_id, lc.category_name, le.lecture_price, le.lecture_state
...
FROM lecture le
JOIN lecture_category lc ON (lc.CATEGORY_ID = le.lecture_category_id)
